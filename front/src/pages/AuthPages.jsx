...
function BrandPanel() {
    return (
        <aside className="brand-panel" aria-label="Football Market Platform">
...
export function Login({ onLogin }) {
    ...
    return (
        <AuthLayout
            ...
            intro="Accedé a tu cuenta para gestionar la plataforma."
            footer={
                <>
...
export function Register() {
    ...
    return (
        <AuthLayout
            ...
            intro="Completá tus datos para comenzar."
            footer={
                <>
